...
while True:
    lat= 10.635803
    lon= 78.102012
    location= "Indhra Nagar,South Gandhigramam,Karur"
    ...
    if level=="90%" or load=="90%":
          warn = 'alert:''Dustbin is almost filled in latitude:10.635803 and longitude:78.102012 Indhra Nagar,South Gandhigramam,Karur'
    
    def myOnPublishCallback(latitude=10.635803,longitude=78.102012):
        print("Indhra Nagar,South Gandhigramam,Karur")
